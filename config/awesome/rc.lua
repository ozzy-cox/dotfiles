...
globalkeys = gears.table.join(
  ...
  end, { description = 'Mute', group = 'Fn Keys' }),
  ...
  awful.key({ modkey }, 'Escape', function()
    awful.spawn '/home/ozank/lock.sh'
  end, { description = 'Lock screen', group = 'Utils' }),
  awful.key({ modkey }, 'c', function()
    awful.spawn 'flameshot gui'
  end, { description = 'Get screenshot', group = 'Utils' }),

  -- Keyboard
  awful.key({ modkey, 'Control' }, 'u', function()
    awful.spawn 'setxkbmap custom_us custom'
  end, { description = 'Change keyboard to US layout', group = 'Keyboard' }),
